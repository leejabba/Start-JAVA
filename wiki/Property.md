...
public class PeopleMain {
	...
	public static void main(String[] args) {
		...
		// ArrayList의 다형성, People 오브젝트만 값으로 가질 수 있도록 제네릭 설정
		List<People> arrayPeople = new ArrayList<People>();	
...
public class PeopleMain {
	...
	public static void main(String[] args) {
		...
		for(int i=0 ; i<5 ; i++){
			// arrayPeople가 이미 People 데이터타입으로 만들어졌으므로 바로 인스턴스 생성이 가능
			arrayPeople.add(new People());	
		}
	}
